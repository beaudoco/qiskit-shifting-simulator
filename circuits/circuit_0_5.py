...
file_counts = open("circuit_0_5_{}_{}.txt".format(num_gates, backend), "a")

if not os.path.exists("circuit_0_5_manila.xlsx"):
    wb = xl.Workbook()
    ws = wb.active
    ...
    wb = xl.load_workbook(filename="circuit_0_5_manila.xlsx")
    ws = wb.active
...
wb.save("circuit_0_5_manila.xlsx")
file_counts.close()
